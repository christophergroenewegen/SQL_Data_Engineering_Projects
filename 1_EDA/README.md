...
A SQL project analyzing the data engineer job market using real world job postings data. It demonstrates my ability to **write production-quality analytical SQL, design efficient queries, and turn business questions into data-dirven insights**.
...
- **Analytics**: Applied **aggregations, filtering, and sorting** to find top skills by demand, salary, and overalal value  
- **Outcomes**: Delivered actionable insights on SQL/Python dominance, cloud trends and salaray patterns.  
  
If you only have a minute, review these:  
  
1. [01_top_demanded_skills.sql](01_top_demanded_skills.sql) - demand analysis with multi-table joins  
2. [02_top_paying_skills.sql](02_top_paying_skills.sql) - salaray analysis with aggregations  
...
- **Most in-demad:** *Which skills command the highest salaries?*   
- **Highest paid:** *Which skills command the highest salaries?*  
- **Best trade-off:** *What is this optimal skill set balancing demand and compensation?*  
  
This project analyzes a **data warehouse** built using a star schema design. The warehouse structure consists of:  

![Data Warehouse](../Images/1_2_Data_Warehouse.png)  
  
-**Fact Table:** `job_postings_fact` - Central table containing job posting details (job titlesm locations, salaries, dates, etc.)  
-**Dimension Tables:**  
...
- **Developement:** VS Code for SQL editing + Terminal for DuckDB CLI  
...
- Cloud platform:  AWS and Azure are critical for modern data engineer roles-  
...
- **Conditional Logic**: `CASE WHEN` statement for derived metrics  
- **Mathematical Functions**: `LN()` for natural logarithm transformation to normalize demand metrics  
- **Calculated Metrics**: Derived optimal score combining log-transformed demand with mediam salary  
